...
#define  x_in_de_crease 00010000
#define  y_in_de_crease 00000001
...
unsigned int fitness_selector(gene_header** read_address,unsigned int counter,unsigned char user_input,omok_space * omok);

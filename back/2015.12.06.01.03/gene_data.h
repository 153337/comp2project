...
unsigned int fitness_selector(gene_header** read_address,unsigned int mode,unsigned char user_input,omok_space * omok,tree * tree_node);
...
//	start = read_address[counter_gene_head]->neck_node;
	...
	else
	{
		...
		if(mode == 0)
		{
			...
			{
				tree_node->next[counter2] = (tree*)malloc(sizeof(tree_node));
			}
			
		
			if(omok->space[x+1][y+1] == 0)// 수가 놓여있는가 테스트 
			{
				tree_node->next[2]->value = 0;
				tree_node->next[2]->pos = user_input+x_in_de_crease+y_in_de_crease;
				tree_node->next[2]->head = tree_node;
			}
			else if(omok->space[x+1][y+1] == 1)
			{
				tree_node->next[2]->value = 1;
				tree_node->next[2]->pos = user_input+x_in_de_crease+y_in_de_crease;
				tree_node->next[2]->head = tree_node;
			}
			else if(omok->space[x+1][y+1] == 2)
			{
				tree_node->next[2]->value = 2;
				tree_node->next[2]->pos = user_input+x_in_de_crease+y_in_de_crease;
				tree_node->next[2]->head = tree_node;
			}
			///////////////////////////////////////////////////////////////////////
			
			if(omok->space[x+1][y] == 0)// 수가 놓여있는가 테스트 
			{
				tree_node->next[4]->value = 0;
				tree_node->next[4]->pos = user_input+x_in_de_crease;
				tree_node->next[4]->head = tree_node;
			}
			if(omok->space[x+1][y] == 1)// 수가 놓여있는가 테스트 
			{
				tree_node->next[4]->value = 1;
				tree_node->next[4]->pos = user_input+x_in_de_crease;
				tree_node->next[4]->head = tree_node;
			}
			if(omok->space[x+1][y] == 2)// 수가 놓여있는가 테스트 
			{
				tree_node->next[4]->value = 2;
				tree_node->next[4]->pos = user_input+x_in_de_crease;
				tree_node->next[4]->head = tree_node;
			}
			
			
			if(omok->space[x][y+1] == 0)// 수가 놓여있는가 테스트 
			{
				tree_node->next[1]->value = 0;
				tree_node->next[1]->pos = user_input+y_in_de_crease;
				tree_node->next[1]->head = tree_node;
			}
			if(omok->space[x][y+1] == 1)// 수가 놓여있는가 테스트 
			{
				tree_node->next[1]->value = 1;
				tree_node->next[1]->pos = user_input+y_in_de_crease;
				tree_node->next[1]->head = tree_node;
			}
			if(omok->space[x][y+1] == 2)// 수가 놓여있는가 테스트 
			{
				tree_node->next[1]->value = 2;
				tree_node->next[1]->pos = user_input+y_in_de_crease;
				tree_node->next[1]->head = tree_node;
			}
			...
			if(omok->space[x-1][y] == 0)// 수가 놓여있는가 테스트 
			{
				tree_node->next[3]->value = 0;
				tree_node->next[3]->pos = user_input-x_in_de_crease;
				tree_node->next[3]->head = tree_node;
			}
			if(omok->space[x-1][y] == 1)// 수가 놓여있는가 테스트 
			{
				tree_node->next[3]->value = 1;
				tree_node->next[3]->pos = user_input-x_in_de_crease;
				tree_node->next[3]->head = tree_node;
			}
			if(omok->space[x-1][y] == 2)// 수가 놓여있는가 테스트 
			{
				tree_node->next[3]->value = 2;
				tree_node->next[3]->pos = user_input-x_in_de_crease;
				tree_node->next[3]->head = tree_node;
			}
			...
			if(omok->space[x][y-1] == 0)// 수가 놓여있는가 테스트 
			{
				tree_node->next[6]->value = 0;
				tree_node->next[6]->pos = user_input-y_in_de_crease;
				tree_node->next[6]->head = tree_node;
			}
			if(omok->space[x][y-1] == 1)// 수가 놓여있는가 테스트 
			{
				tree_node->next[6]->value = 1;
				tree_node->next[6]->pos = user_input-y_in_de_crease;
				tree_node->next[6]->head = tree_node;
			}
			if(omok->space[x][y-1] == 2)// 수가 놓여있는가 테스트 
			{
				tree_node->next[6]->value = 2;
				tree_node->next[6]->pos = user_input-y_in_de_crease;
				tree_node->next[6]->head = tree_node;
			}
			...
			if(omok->space[x+1][y-1] == 0)// 수가 놓여있는가 테스트 
			{
				tree_node->next[7]->value = 0;
				tree_node->next[7]->pos = user_input+x_in_de_crease-y_in_de_crease;
				tree_node->next[7]->head = tree_node;
			}
			if(omok->space[x+1][y-1] == 1)// 수가 놓여있는가 테스트 
			{
				tree_node->next[7]->value = 1;
				tree_node->next[7]->pos = user_input+x_in_de_crease-y_in_de_crease;
				tree_node->next[7]->head = tree_node;
			}
			if(omok->space[x+1][y-1] == 2)// 수가 놓여있는가 테스트 
			{
				tree_node->next[7]->value = 2;
				tree_node->next[7]->pos = user_input+x_in_de_crease-y_in_de_crease;
				tree_node->next[7]->head = tree_node;
			}
			...
			if(omok->space[x-1][y+1] == 0)// 수가 놓여있는가 테스트 
			{
				tree_node->next[5]->value = 0;
				tree_node->next[5]->pos = user_input-x_in_de_crease+y_in_de_crease;
				tree_node->next[5]->head = tree_node;
			}
			if(omok->space[x-1][y+1] == 1)// 수가 놓여있는가 테스트 
			{
				tree_node->next[5]->value = 1;
				tree_node->next[5]->pos = user_input-x_in_de_crease+y_in_de_crease;
				tree_node->next[5]->head = tree_node;
			}
			if(omok->space[x-1][y+1] == 2)// 수가 놓여있는가 테스트 
			{
				tree_node->next[5]->value = 2;
				tree_node->next[5]->pos = user_input-x_in_de_crease+y_in_de_crease;
				tree_node->next[5]->head = tree_node;
			}
			...
			if(omok->space[x-1][y-1] == 0)// 수가 놓여있는가 테스트 
			{
				tree_node->next[0]->value = 0;
				tree_node->next[0]->pos = user_input-x_in_de_crease-y_in_de_crease;
				tree_node->next[0]->head = tree_node;
			}
			if(omok->space[x-1][y-1] == 1)// 수가 놓여있는가 테스트 
			{
				tree_node->next[0]->value = 1;
				tree_node->next[0]->pos = user_input-x_in_de_crease-y_in_de_crease;
				tree_node->next[0]->head = tree_node;
			}
			if(omok->space[x-1][y-1] == 2)// 수가 놓여있는가 테스트 
			{
				tree_node->next[0]->value = 2;
				tree_node->next[0]->pos = user_input-x_in_de_crease-y_in_de_crease;
				tree_node->next[0]->head = tree_node;
			}
...
unsigned int learn_fight(gene_header** read_address) // 프로그램을 학습 시킨다. 
{
	...
	while(1)
	{
		...
		if(keyboard_key == 13)
		{
			...
			pos = x+y;
			printf("입력\n");
			fitness_selector(read_address,0,pos,&fight_place,&make_tree);
